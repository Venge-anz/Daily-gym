  ...
  return (
    <>
      <div className="flex flex-col items-center mt-24 justify-center md:px-40 mx-auto">
        <div className="flex flex-col md:flex-row items-center md:items-start w-full bg-gradient-to-br from-gray-800 via-gray-700 to-gray-900 rounded-2xl px-10 py-12 shadow-2xl">
          <img
            src="/invitaAmigo.png"
            alt="imagenInvita"
          ...
          <div className="flex flex-col md:ml-12 mt-10 md:mt-0 w-full p-10">
            <h1 className="text-5xl md:text-7xl font-extrabold text-amber-50 text-right leading-tight">
              Get stronger together.
            </h1>

            <div className="flex flex-row justify-between items-center mt-10 p-3 ml-2 md:ml-6">
              <div>
                <p className="text-2xl font-light italic text-gray-400 border-b border-gray-500 pb-1 mb-2">
                  Invite a friend.
                </p>
